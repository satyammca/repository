...
<c:choose>
	<c:when test="<%= permissionChecker.isOmniadmin() %>">
		...
		<aui:form action="<%= portletURL.toString() %>" method="post" name="fm">
			...
			<strong><liferay-ui:success key="clean-updeployed-portlets-success" message="Successfully cleaned all undeployed portlets entries from database tables. You can refer log for more details.."/></strong><br/>
			<c:choose>
